 ...
 */
class Custom_Validate_DateCompare extends Zend_Validate_Abstract
{
    /**
     * Error codes
     * @const string
    ...
    protected $_messageTemplates = array(
        ...
        self::NOT_LATER      => "The date '%value%' is not later than the Start Date",
        self::NOT_EARLIER    => "The date '%value%' is not earlier than the End Date",
